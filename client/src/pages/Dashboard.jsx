  ...
  return (
    <div className='min-h-screen'>
      ...
      <div className='shadow py-4'>
            ...
            <img onClick={e=> navigate('/')} className='max-sm:w-32 cursor-pointer' src={assets.logo} alt="" loading="lazy" />
            {companyData && (<div className='flex items-center gap-3'>
               <p className='max-sm:hidden'>Welcome, {companyData.name}</p> 
               <div  className='relative group'>
                <img  className='w-8 border rounded-full' src={companyData.image} alt="" loading="lazy"/>
    ...
    <div className='flex items-starts'>
        ...
        <ul className='flex flex-col items-start pt-5 text-gray-800'>
                ...
                <img className='min-w-4' src={assets.add_icon} alt="" loading="lazy"/>
                ...
                <img className='min-w-4' src={assets.home_icon} alt="" loading="lazy"/>
                ...
                <img className='min-w-4' src={assets.person_tick_icon} alt="" loading="lazy"/>
